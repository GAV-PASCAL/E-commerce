            ...
            <form class="inscription" method="POST" action="{{ route('register.post') }}">
                ...
                <div style="margin: 2px 0; display: flex; align-items: flex-start; gap: 5px;">
                    ...
                    <label for="politique_confidentialite" style="font-size: 0.9rem; color: #4b5563; cursor: pointer;">
                        J'ai lu et j'accepte la <a href="{{ route('politique.confidentialite') }}" target="_blank" style="color: var(--primary-color); font-weight: 600;">politique de confidentialité</a> d'EasyOrder.
                    </label>
                </div>
                ...
                <p>
                    Déjà un compte ? <a href="{{ route('login') }}" style="color: var(--primary-color); font-weight: 600;">Se connecter</a>
