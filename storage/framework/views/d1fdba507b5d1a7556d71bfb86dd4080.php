    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($conversation): ?>
        <div class="chat-header">
            <div class="client-info">
                ...
                <div>
                    <h3><?php echo e($conversation->user->prenom); ?> <?php echo e($conversation->user->nom); ?></h3>
                    <p class="client-email"><?php echo e($conversation->user->email); ?></p>
                </div>
            </div>
                    ...
                    <div class="message-content">
                        <div class="message-header">
                            <span class="message-sender">
                                ...
                                <?php else: ?>
                                    <i class='bx bx-user'></i> <?php echo e($message['sender']['prenom']); ?> <?php echo e($message['sender']['nom']); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message['produit']): ?>
                            <div class="message-produit">
                                ...
                                <div>
                                    ...
                                    <p><?php echo e($message['produit']['nom']); ?> - <?php echo e(number_format($message['produit']['prix'], 0, ',', ' ')); ?> FCFA</p>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\Users\pasca\Documents\fast\poto\resources\views/livewire/vendor-chat-box.blade.php ENDPATH**/ ?>